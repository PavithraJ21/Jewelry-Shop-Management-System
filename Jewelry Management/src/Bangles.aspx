<%@ Page Title="" Language="C#" MasterPageFile="~/Sitejms1.Master" AutoEventWireup="true" CodeBehind="Bangles.aspx.cs" Inherits="JMS.Bangles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:masterConnectionString %>" SelectCommand="SELECT [Jewel_Id], [Jewel_Name], [Jewel_Description], [Price], [Weight], [image] FROM [Jewel1] where [Jewel_Category]='Bangle' and [Quantity]>0"></asp:SqlDataSource>
